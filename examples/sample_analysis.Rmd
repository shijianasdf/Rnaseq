...
fn.yml<-"/nas/is1/zhangz/projects/mills/2015-12-CDLS_RNAseq/result/sample_analysis/rnaseq_sample.yml"; 
...
Between-sample normalization was done by converting read counts of genes to FPKM (fragments per kilobase per million reads). 
